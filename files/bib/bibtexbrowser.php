...
<!--this is version v20101203, see http://www.monperrus.net/martin/bibtexbrowser/ -->
...
Create a bib file with the publication records (e.g. my.bib) and upload it to your server.
* Use the link ''bibtexbrowser.php?bib=my.bib'' (frameset based view)
* Use the link ''bibtexbrowser.php?bib=my.bib&amp;all'' (pub list sorted by year)
* Use the link ''bibtexbrowser.php?bib=my.bib&amp;all&amp;academic'' (pub list  sorted by publication type, then by year)
...
''bibtexbrowser.php?bib=strings.bib;my.bib''
...
?><?php /* pp4php: including bibtexbrowser/dev/bibtexbrowser-style-default.php (in bibtexbrowser/dev/bibtexbrowser.php:1366) */ ?><?php /** default bibliography btyle of bibtexbrowser 
...
class BibtexBrowserDisplay {
  ...
  function poweredby() {
    ...
    $poweredby .= 'Powered by <a href="http://www.monperrus.net/martin/bibtexbrowser/">bibtexbrowser</a><!--v20101203-->';
    $poweredby .= '</div>'."\n";
    return $poweredby;
   }
...
<meta name="generator" content="bibtexbrowser v20101203" />
...
<rss version="2.0" xmlns:atom="http://www.w3.org/2005/Atom">
   <channel>
      ...
      <generator>bibtexbrowser v20101203</generator>
...
class Dispatcher {
  ...
  function diagnosis() {
    ...
    echo "bibtexbrowser version: 20101203\n";
